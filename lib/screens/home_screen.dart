        ...
        child: Column(
          ...
          children: <Widget>[
            Row(
              ...
              children: <Widget>[
                Text(category.name, style: kHeadingStyle2),
                Text(
            ...
            LayoutBuilder(
              builder: (BuildContext context, BoxConstraints constraints) {
                final double boxMaxWidth = constraints.maxWidth;
                ...
                return Stack(
                  children: <Widget>[
                    ...
                    Container(
                      height: 20.0,
                      width: boxMaxWidth * percent,
                      decoration: BoxDecoration(
                        color: getColorBrighten(
                            Theme.of(context).primaryColor, 1 - percent),
                        borderRadius: BorderRadius.circular(15.0),
                      ),
                    ),
                  ],
            ...
            delegate: SliverChildBuilderDelegate(
              (context, index) {
                if (index == 0) {
                  ...
                  category.expenses.forEach((Expense exp) {
